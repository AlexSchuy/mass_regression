...
class HiggsLoss(nn.Module):
    ...
    def forward(self, outputs: torch.Tensor, attributes: torch.Tensor, targets: torch.Tensor):
        ...
        Nbx_pred, Nby_pred, Wam_pred, Wbm_pred, Hm_pred = calc_tree(outputs, attributes)
