...
class Run():
    ...
    def get_train_test_datasets(self, full_dataset=False):
        return data.get_train_test_datasets(self.train_size, self.test_size, self.seed, self.dataset, full_dataset)
...
def main():
    ...
    parser.add_argument('--dataset', default='Wlnu', choices=validate.DATASETS, help='The dataset to use.')
    parser.add_argument('--hidden_layers', default='100', help='The dimensions of the hidden layers in the nn.')
