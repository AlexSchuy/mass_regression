...
def main():
    ...
    delta_callback = args.single_run
    trainer = WlnuTrainer(model_factory, dataset, delta_callback=delta_callback, early_stopping=True)
    if not args.single_run:
        ...
        hparams = {"num_layers": 4, "num_units": 170.0, "learning_rate": 0.0011848734045499054,
                   "batch_size": 256, "epochs": 1000, "dropout": 0.0, "run_num": 2}
        trainer.train_test_model(hparams)
